...
"}")
        ...
        self.Image.setGeometry(QRect(208, 0, 1001, 631))
        self.Image.setCursor(QCursor(Qt.SizeHorCursor))
        self.Image.setPixmap(QPixmap(u"D:/designs-web/31385783667_ac3590d0cf_b.jpg"))
...
"}")
        ...
        self.Image_copy.setGeometry(QRect(208, 0, 1001, 631))
        self.Image_copy.setCursor(QCursor(Qt.SizeHorCursor))
        self.Image_copy.setPixmap(QPixmap(u"D:/designs-web/31385783667_ac3590d0cf_b.jpg"))
        self.Image_copy.setScaledContents(True)
        self.Image_copy.setWordWrap(False)
        self.AdjustMenu = QFrame(self.centralwidget)
        self.AdjustMenu.setObjectName(u"AdjustMenu")
        self.AdjustMenu.setEnabled(True)
        self.AdjustMenu.setGeometry(QRect(220, 340, 61, 281))
